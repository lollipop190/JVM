...
public class ConstantPoolInfo {
    ...
    public static Pair<ConstantPoolInfo, Integer> getConstantPoolInfo(ConstantPool constantPool, byte[] classfile, int ofs) {
        ...
        switch (tag) {
            ...
            case UTF8: {
                 ...
                 * Add some codes here.
                 */
                int bytes_length = in.getU2();
                ret = new UTF8Info(constantPool,bytes_length,readGivenBytes(in, bytes_length));
                bytesRead += (2+bytes_length);
                break;
            }
    ...
    private static byte[] readGivenBytes(BuildUtil in, int length){
